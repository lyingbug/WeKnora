export default {
  ...
  settings: {
    ...
    notesMode: {
      title: 'Notes mode (Typora-style)',
      description:
        'When enabled, the sidebar keeps Notes, Search, Chat and Settings only, and the home route opens your notes list—ideal for Markdown writing and capture.',
      switchedOn: 'Notes mode enabled',
      switchedOff: 'Notes mode disabled',
      navigateTitle: 'Open notes home',
      navigateBody: 'You are on a knowledge-base or admin page. Go to the notes list?',
      navigateConfirm: 'Go to notes',
      exitMode: 'Exit notes mode',
    },
  ...
  manualEditor: {
    ...
    openInWindow: 'Edit in full screen',
  },
  notes: {
    defaultNotebookName: 'My Notes',
    chat: {
      title: 'Notes Assistant',
      headSub: 'Ask your knowledge base — open full view or start fresh',
      headOpenFull: 'Full',
      headNewSession: 'New',
      closePanel: 'Close panel',
      openFull: 'Open in full chat',
      newSession: 'New conversation',
      unavailable: 'Chat is unavailable; please retry.',
      retry: 'Retry',
      createFailed: 'Failed to start a conversation',
    },
    welcome: {
      featWriteTitle: 'Distraction-free writing',
      featWriteDesc: 'Typora-style full-screen Markdown with autosave and a focused canvas.',
      featPublishTitle: 'One-click publish',
      featPublishDesc: 'Drafts stay out of the index; publish to make notes retrievable.',
      featShortcutsTitle: 'Keyboard shortcuts',
      featShortcutsDesc: 'Save, format, preview—all at your fingertips.',
      dragHint: 'You can also drop a .md file onto the editor to start',
    },
    errors: {
      noModel: 'Configure default chat and embedding models in Model Management before creating the notes knowledge base.',
      createNotebookFailed: 'Failed to create default notebook',
    },
    list: {
      title: 'Notes',
      subtitle: 'Markdown drafts; publish to make them searchable',
      newNote: 'New note',
      searchPlaceholder: 'Search title or excerpt',
      kbDefault: 'My Notes',
      kbAll: 'All Notes',
      kbScopeTitle: 'By notebook',
      newNotebook: 'New Notebook',
      notebookNamePlaceholder: 'Enter notebook name',
      notebookBasicDesc: 'Set the name and description for the notebook.',
      notebookModelsDesc: 'Select suitable AI models for the notebook.',
      notebookStorageGlobalDesc: 'Configure the storage engine used to store unstructured and structured data extracted from notes.',
      notebookStorageDesc: 'Select the storage engine for this notebook. The corresponding engine must be configured in global settings.',
      notebookCreate: 'Create Notebook',
      notebookNameLabel: 'Notebook Name',
      notebookDescLabel: 'Notebook Description',
      notebookDescPlaceholder: 'Enter notebook description',
      filterAll: 'All',
      filterDraft: 'Draft',
      filterPublished: 'Published',
      emptyTitle: 'No notes yet',
      emptyDesc: 'Create a note or enable Notes mode in settings for a focused writing layout.',
      ...
      move: 'Move to another knowledge base',
      moveFailed: 'Move failed',
      moveTimeout: 'Move is still processing; refresh if the list looks wrong.',
      ...
      noNotesYet: 'No notes yet—create one from the right',
      noMatch: 'No notes match',
      clearFilters: 'Clear search & filters',
      tipSave: 'Save draft',
      tipBold: 'Bold',
      tipPreview: 'Toggle preview',
      justNow: 'just now',
    ...
    editor: {
      ...
      viewSplit: 'Split',
      viewPreview: 'Preview',
      kbSettings: 'Target knowledge base',
      publishTitle: 'Publish to index',
      republish: 'Republish',
      publishHint: 'After publishing, content is indexed for retrieval and answers.',
      chars: '{n} chars',
      words: '{n} words',
      saving: 'Saving…',
      savedJustNow: 'Saved',
      ...
      kbNotReady: 'This knowledge base is missing model setup; save/publish is disabled. Complete initialization in settings.',
      kbNoStorage: 'This knowledge base has no storage engine configured. Pick one in KB settings, or delete this KB so notes can recreate it.',
      kbDialogHint: 'Changing the target knowledge base for a saved note moves it (removed from the old base, added to the new one).',
      kbMoveConfirm: 'Move this note to "{name}"? It will no longer appear in the current knowledge base.',
    },
    wiki: {
      title: 'Wiki Knowledge Graph',
      refresh: 'Refresh',
      notEnabled: 'Wiki not enabled',
      notEnabledDesc: 'Wiki is not enabled for this notebook. New notebooks have it on by default; enable it in KB settings for existing ones.',
      notPublished: 'Note not published',
      notPublishedDesc: 'Publish this note and the AI will automatically extract entities, concepts, and generate Wiki pages.',
      summary: 'Summary',
      related: 'Related Pages',
      backlinks: 'Backlinks',
      noPages: 'No related Wiki pages yet — they will be generated after you publish',
      typeSummary: 'Summary',
      typeEntity: 'Entity',
      typeConcept: 'Concept',
      ...
      typeIndex: 'Index',
      typeLog: 'Log',
      suggestHint: 'Wiki / Notes · Tab or Enter to select',
      typeNote: 'Note',
      ...
      linkExists: 'Exists',
      linkMissing: 'Missing',
      noLinks: 'No [[links]] in this note yet',
      noLinksHint: 'Type [[ in the editor to start',
    },
    link: {
      suggestHint: 'Notes · Tab / Enter to select',
    },
  },
  input: {
    addModel: 'Add Model',
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      typeDescription: 'FAQ suits structured Q&A datasets; document type supports file parsing and chunking; Wiki type auto-builds pages; Notebook is dedicated to pure text and Markdown notes.',
