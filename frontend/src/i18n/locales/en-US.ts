...
\
  ...
  audioRecorder: {
    ...
    stopping: 'Processing...',
    readyToRecord: 'Ready',
    clickToStart: 'Click the button below to start recording with real-time transcription',
    confirmed: 'Confirmed',
    ...
    browserNotSupport: 'Your browser does not support audio recording',
    asrNotEnabled: 'Please enable streaming ASR in the knowledge base settings first',
    connectionFailed: 'Failed to connect to speech recognition service',
    saveSuccess: 'Voice input saved to knowledge base',
    saveFailed: 'Failed to save',
  },
}
