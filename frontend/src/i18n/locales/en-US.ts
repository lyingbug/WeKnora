export default {
  ...
  memory: {
    ...
    subtitleShort: 'Browse, edit, and manage what WeKnora remembers about you.',
    tabs: {
	  saved: 'Saved',
	  history: 'From chats',
      memories: 'Memories',
    ...
    list: {
      ...
      empty: 'Nothing remembered yet. Add a memory by hand, or say "remember this" in a conversation.',
	  historyEmpty: 'Nothing useful has been inferred from chats yet. Items here are used only when relevant.',
      updated: 'Updated {date}',
      used: 'Used {count} times',
	  savedOrigin: 'Saved',
	  historyOrigin: 'From chat',
      strength: 'Strength {value}%',
      strengthHint: 'Memories that go unused fade and are eventually archived. Pinning exempts one from decay.',
      pin: 'Pin',
      unpin: 'Unpin',
      pinned: 'Pinned — this memory will no longer fade',
      unpinned: 'Unpinned',
      edit: 'Edit',
      forget: 'Forget',
      forgetHeader: 'Forget this memory?',
      forgetBody: '"{title}" will be deleted along with the anchors it created in your knowledge bases. This cannot be undone.',
      forgotten: 'Forgotten',
    },
    inbox: {
      intro: 'These were extracted from things you said and are waiting for your approval. Edit the wording before accepting if it is not quite right.',
      empty: 'Nothing waiting for review.',
      confidence: 'Confidence {value}%',
      viewSource: 'View the conversation',
      accept: 'Accept',
      reject: 'Reject',
      accepted: 'Added to your memory',
    },
    graph: {
      noAnchors: 'Nothing in this space points at the knowledge base yet. Use it in a conversation and what you engage with shows up here.',
      modePersonal: 'My memory',
      modeBridged: 'Memory ∩ knowledge base',
      personalHint: 'Memories linked to each other with [[links]].',
      bridgedHint: 'Dashed nodes are knowledge-base items you have engaged with; a line means a memory is anchored to one.',
      bridgedHintShort: 'Dashed nodes are knowledge-base items; solid lines are memory anchors.',
      legendMemory: 'Memory',
      legendWiki: 'Knowledge base',
      empty: 'Not enough memories to draw a graph yet.',
      truncated: 'Showing {returned} of {total} nodes.',
      helpTitle: 'Graph controls',
      helpClick: 'Click',
      helpClickDesc: 'Open node detail',
      helpDblClick: 'Double-click memory',
      helpDblClickDesc: 'Open editor',
      helpDrag: 'Drag',
      helpDragDesc: 'Reposition a node',
      helpZoom: 'Scroll',
      helpZoomDesc: 'Zoom the canvas',
      drawerEdit: 'Edit memory',
      drawerOpenWiki: 'View in knowledge graph',
      drawerVersion: 'Version {ver}',
      drawerNoContent: 'No body content',
      drawerSatelliteHint: 'Knowledge-base item you have engaged with. Memories anchor here — open the knowledge graph for full detail.',
    },
    editor: {
      createHeader: 'New memory',
      editHeader: 'Edit memory',
      save: 'Save',
      cancel: 'Cancel',
      saved: 'Saved',
      reverted: 'Reverted',
      conflict: 'This memory changed while you had it open. The latest version has been reloaded.',
      emptyWarning: 'Please fill in at least a summary or a body.',
      type: 'Type',
      typeLocked: 'The type is part of the address and cannot change after creation.',
      title: 'Title',
      titlePlaceholder: 'One line describing this memory',
      summary: 'Summary',
      summaryPlaceholder: 'The single line that gets used in conversations',
      summaryHint: 'This is the line the assistant actually sees, so keep it short and specific.',
      content: 'Body',
      contentPlaceholder: 'Details, in Markdown',
      linkHint: 'Use [[slug]] to link to another memory; links show up in the graph.',
      language: 'Language',
      verbosity: 'Detail',
      format: 'Format',
      codeStyle: 'Code examples',
      pinned: 'Pin',
      pinnedHint: 'Pinned memories never fade.',
      preferenceSection: 'Preference settings',
      history: 'History',
      revert: 'Revert to this version',
    },
    forgetAll: {
      header: 'Forget everything?',
      body: 'This deletes all of your memories, the observations behind them and their knowledge-base anchors. It cannot be undone.',
    ...
    illuminate: {
      ...
      mastered: 'Mastered',
      flagged: 'Disputed',
      familiarHint: 'Pages you keep coming back to, recently.',
      masteredHint: 'Pages you confirmed you understand, or own.',
      flaggedHint: 'Pages you corrected or disagreed with.',
    ...
    settingsDrawer: {
      description: 'Control how memories are written, recalled, and protected. Changes save immediately.',
    },
    settings: {
      showAdvanced: 'Show all settings',
      hideAdvanced: 'Hide other settings',
      saved: 'Saved',
      patternPlaceholder: 'One regex pattern per line',
      readonly: {
        on: 'On',
        off: 'Off',
        empty: 'Not set',
      ...
      fromDefault: 'System preset',
      layers: {
        deployment: 'the deployment',
        tenant: 'your workspace',
        agent: 'the agent',
        user: 'your settings',
        space: 'your memory space',
        default: 'the default',
      },
      groups: {
        general: { title: 'General', description: 'Whether memory is on, and which channels it applies to.' },
        write: { title: 'What gets remembered', description: 'What may be recorded, and whether you approve it first.' },
        recall: { title: 'Recall', description: 'Which memories reach a conversation, and how much context they may use.' },
        boost: { title: 'Personalised ranking', description: 'Prefer knowledge-base content you have already engaged with.' },
        anchor: { title: 'Anchors and illumination', description: 'How memory connects to your knowledge bases, and how that is shown on the graph.' },
        lifecycle: { title: 'Fading and retention', description: 'How memories fade over time, and how long they are kept.' },
        privacy: { title: 'Privacy and safety', description: 'Handling of sensitive content and injection defences. These can only be tightened.' },
        insights: { title: 'Insights', description: 'Anonymised aggregates that expose gaps in a knowledge base.' },
      },
      options: {
        mentioned: 'Mentioned',
        ...
        corrected: 'Corrected',
        owns: 'Owned by me',
        user_message: 'My own messages',
        off: 'Off',
        explicit_only: 'Only when I ask',
        gated_auto: 'Automatic when triggered',
        always_auto: 'Always automatic',
      ...
      keys: {
        memory_enabled: { label: 'Enable long-term memory', help: 'When off, nothing is read and nothing is written. You can always switch it off for yourself.', label_tenant: 'Enable for the whole workspace', help_tenant: 'With this off, no member has long-term memory and none can switch it on for themselves.' },
        memory_channels: { label: 'Channels', help: 'Which channels get a long-term memory space.' },
        memory_embed_visitor_space: { label: 'Embed visitors', help: 'Visitor identity comes from the client, so persistent memory for them is opt-in.' },
        memory_shared_space_enabled: { label: 'Shared team memory', help: 'Give the workspace a shared memory space.' },
        memory_write_mode: { label: 'How memories are recorded', help: 'From nothing at all, through only what you explicitly ask for, to automatic extraction.', label_tenant: 'Furthest capture permitted', help_tenant: 'The most any member may choose. Set to explicit-only and no one can enable automatic extraction.' },
        memory_write_require_review: { label: 'Ask me first', help: 'Extracted candidates wait in the review inbox until you accept them.', label_tenant: 'Require member confirmation', help_tenant: 'Extracted candidates always wait for review; members cannot skip that step.' },
        memory_write_allowed_types: { label: 'Types that may be recorded', help: 'For example, preferences only.', label_tenant: 'Permitted types', help_tenant: 'Members may narrow this further for themselves, but never widen it.' },
        memory_write_min_confidence: { label: 'Minimum confidence', help: 'Candidates below this are discarded.' },
        memory_write_gate_keywords: { label: 'Trigger phrases', help: 'Extraction is only considered when one of these appears.' },
        memory_write_debounce_seconds: { label: 'Extraction debounce (s)', help: 'Several turns in one window become a single extraction.' },
        memory_write_turn_interval: { label: 'Turn interval', help: 'Consider extraction every N turns even without a trigger phrase.' },
        memory_write_max_notes_per_window: { label: 'Candidates per window', help: 'Upper bound on what one extraction may produce.' },
        memory_write_extraction_model_id: { label: 'Extraction model', help: 'Leave empty to use the conversation model.' },
        memory_recall_enabled: { label: 'Use memory in conversations', help: 'When off, memory is written but never read.', label_tenant: 'Allow memory in conversations', help_tenant: 'With this off, memory is injected into no conversation, for any member.' },
        memory_recall_relevance_enabled: { label: 'Recall by relevance', help: 'When off, only always-on memories are injected and no search happens at all.' },
        memory_recall_always_include_types: { label: 'Always-on types', help: 'These are injected on every turn.' },
        memory_recall_max_items: { label: 'Maximum memories per turn', help: 'How many memories may be injected at once.' },
        memory_recall_injection_token_budget: { label: 'Token budget', help: 'Context memory may occupy; anything over is dropped by priority.' },
        memory_recall_timeout_ms: { label: 'Recall timeout (ms)', help: 'Exceeding it skips memory rather than slowing the answer.' },
        memory_boost_enabled: { label: 'Personalised ranking', help: 'Off by default: measure it in your own setting before turning it on.' },
        memory_boost_factor: { label: 'Boost factor', help: 'Score multiplier for results you have engaged with.' },
        memory_anchor_runtime_enabled: { label: 'Record what I read', help: 'Note which wiki pages an answer cited. Costs no model call.' },
        memory_anchor_resolve_enabled: { label: 'Resolve anchors', help: 'Match entities named in a memory to knowledge-base pages.' },
        memory_overlay_enabled: { label: 'Allow illumination', help: 'Shade the wiki graph by how much you have engaged with each page.' },
        memory_overlay_familiar_threshold: { label: '"Familiar" threshold', help: 'Heat at which a page counts as familiar.' },
        memory_overlay_mastered_threshold: { label: '"Mastered" threshold', help: 'Heat at which a page counts as mastered, given a confirming signal.' },
        memory_overlay_relation_weights: { label: 'Relation weights', help: 'How much each kind of interaction contributes to heat.' },
        memory_overlay_anchor_half_life_days: { label: 'Anchor half-life (days)', help: 'How quickly engagement fades.' },
        memory_overlay_decay_exempt_relations: { label: 'Relations that never fade', help: 'Owning or bookmarking a subject is a standing relationship, not a recent interaction.' },
        memory_decay_enabled: { label: 'Let memories fade', help: 'Unused memories weaken and are archived rather than accumulating forever.' },
        memory_decay_half_life_days: { label: 'Half-life per type (days)', help: 'Preferences can last a long time; open questions should not.' },
        memory_decay_archive_threshold: { label: 'Archive threshold', help: 'Below this strength a memory is archived. It stays visible and restorable.' },
        memory_capacity_max_pages_per_space: { label: 'Maximum memories', help: 'Past this, the weakest are archived.' },
        memory_retention_days: { label: 'Retention (days)', help: '0 means never purge, only archive.' },
        memory_retention_purge_archived_after_days: { label: 'Purge archived after (days)', help: '0 keeps archived memories indefinitely.' },
        memory_privacy_pii_redaction: { label: 'Personal information', help: 'What to do with phone numbers, email addresses and similar identifiers.' },
        memory_privacy_blocked_patterns: { label: 'Never record', help: 'Matching content is not stored. Built-in credential patterns always apply.' },
        memory_privacy_admin_metadata_only: { label: 'Administrators see metadata only', help: 'No role has an endpoint that returns another person\'s memory content.' },
        memory_security_injection_sanitize: { label: 'Sanitise before injection', help: 'Strip links, code fences and instruction-shaped text before a memory reaches a prompt.' },
        memory_security_extract_sources: { label: 'Extraction sources', help: 'Only your own messages. Never documents, search results or tool output.' },
        memory_privacy_export_enabled: { label: 'Allow export', help: 'Let members export their own memory.' },
        memory_privacy_forget_enabled: { label: 'Allow deletion', help: 'Let members delete their own memories.' },
        memory_insights_enabled: { label: 'Enable insights', help: 'Surface knowledge-base gaps from anonymised aggregates.' },
        memory_insights_k_anonymity: { label: 'k-anonymity threshold', help: 'Entries fewer than this many people engaged with are suppressed.' },
      },
    },
    errors: {
      exportFailed: 'Export failed',
