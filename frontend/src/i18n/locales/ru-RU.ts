export default {
  ...
  settings: {
    ...
    notesMode: {
      title: 'Режим заметок (стиль Typora)',
      description:
        'В боковой панели остаются заметки, поиск, чат и настройки; домашняя страница открывает список заметок — удобно для Markdown.',
      switchedOn: 'Режим заметок включён',
      switchedOff: 'Режим заметок выключен',
      navigateTitle: 'Перейти к заметкам',
      navigateBody: 'Вы на странице базы знаний или администрирования. Перейти к списку заметок?',
      navigateConfirm: 'К заметкам',
      exitMode: 'Выйти из режима заметок',
    },
...
/example\.(net|org)/`,
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      typeWiki: 'Wiki',
      typeNotebook: 'Блокнот',
      typeDescription: 'FAQ подходит для структурированных Q&A; документальный тип поддерживает загрузку файлов и разбиение; Wiki автоматически создает связанные страницы знаний через LLM; Блокнот предназначен для создания текстовых заметок и Markdown.',
  ...
  manualEditor: {
    ...
    openInWindow: 'Редактировать на весь экран',
  },
  notes: {
    defaultNotebookName: 'Мои заметки',
    chat: {
      title: 'Помощник заметок',
      headSub: 'Вопросы к базе знаний — полный экран или новый диалог',
      headOpenFull: 'Полный',
      headNewSession: 'Новый',
      closePanel: 'Закрыть панель',
      openFull: 'Открыть полный чат',
      newSession: 'Новый диалог',
      unavailable: 'Чат сейчас недоступен. Повторите позже.',
      retry: 'Повторить',
      createFailed: 'Не удалось создать диалог',
    },
    welcome: {
      featWriteTitle: 'Письмо без отвлечений',
      featWriteDesc: 'Полноэкранный Markdown в стиле Typora с автосохранением.',
      featPublishTitle: 'Публикация в один клик',
      featPublishDesc: 'Черновики не индексируются; публикация делает их доступными для поиска.',
      featShortcutsTitle: 'Горячие клавиши',
      featShortcutsDesc: 'Сохранить, отформатировать, просмотреть — на расстоянии руки.',
      dragHint: 'Можно перетащить .md файл прямо в редактор',
    },
    errors: {
      noModel: 'Сначала настройте модели чата и эмбеддингов в разделе управления моделями.',
      createNotebookFailed: 'Не удалось создать блокнот по умолчанию',
    },
    list: {
      title: 'Заметки',
      subtitle: 'Черновики Markdown; после публикации доступны для поиска',
      newNote: 'Новая заметка',
      searchPlaceholder: 'Поиск по заголовку или фрагменту',
      kbDefault: 'Мои заметки',
      kbAll: 'Все заметки',
      kbScopeTitle: 'По блокноту',
      newNotebook: 'Новый блокнот',
      notebookNamePlaceholder: 'Введите название блокнота',
      notebookBasicDesc: 'Задайте название и описание для блокнота.',
      notebookModelsDesc: 'Выберите подходящие ИИ-модели для блокнота.',
      notebookStorageGlobalDesc: 'Настройте хранилище для неструктурированных и структурированных данных, извлеченных из заметок.',
      notebookStorageDesc: 'Выберите хранилище для этого блокнота. Соответствующее хранилище должно быть настроено в глобальных настройках.',
      notebookCreate: 'Создать блокнот',
      notebookNameLabel: 'Название блокнота',
      notebookDescLabel: 'Описание блокнота',
      notebookDescPlaceholder: 'Введите описание блокнота',
      filterAll: 'Все',
      filterDraft: 'Черновики',
      filterPublished: 'Опубликовано',
      emptyTitle: 'Пока нет заметок',
      emptyDesc: 'Создайте заметку или включите режим заметок в настройках.',
      writeFirst: 'Написать первую',
      ...
      move: 'Переместить в другую базу знаний',
      moveFailed: 'Перемещение не удалось',
      moveTimeout: 'Перемещение ещё выполняется; обновите страницу, если список неверен.',
      deleteConfirmTitle: 'Удалить заметку',
      deleteConfirmBody: 'Удалить «{title}»? Действие необратимо.',
      deleteFailed: 'Не удалось удалить',
      unpublish: 'Вернуть в черновик',
      publish: 'Опубликовать',
      tagDraft: 'Черновик',
      tagPublished: 'Опубликовано',
      noExcerpt: 'Нет выдержки',
      untitled: 'Без названия',
      openInEditor: 'Открыть в редакторе',
      noNotesYet: 'Пока нет заметок — создайте справа',
      noMatch: 'Заметки не найдены',
      clearFilters: 'Сбросить поиск и фильтры',
      tipSave: 'Сохранить черновик',
      tipBold: 'Жирный',
      tipPreview: 'Переключить просмотр',
      justNow: 'только что',
    ...
    editor: {
      titlePlaceholder: 'Заметка без названия',
      viewEdit: 'Правка',
      viewSplit: 'Разделение',
      viewPreview: 'Просмотр',
      kbSettings: 'Целевая база знаний',
      publishTitle: 'Опубликовать в индекс',
      republish: 'Опубликовать снова',
      publishHint: 'После публикации контент индексируется для поиска и ответов.',
      chars: '{n} симв.',
      words: '{n} слов',
      saving: 'Сохранение…',
      savedJustNow: 'Сохранено',
      savedSecondsAgo: 'сохранено {n} с назад',
      savedMinutesAgo: 'сохранено {n} мин назад',
      lastSaved: 'сохранено в {time}',
      kbNotReady: 'База знаний не настроена; сохранение и публикация недоступны. Завершите настройку.',
      kbNoStorage: 'У этой базы знаний не настроено хранилище. Выберите его в настройках или удалите базу — заметки создадут её заново.',
      kbDialogHint: 'Смена целевой базы для сохранённой заметки перемещает её (удаление из старой, добавление в новую).',
      kbMoveConfirm: 'Переместить заметку в «{name}»? В текущей базе она исчезнет.',
    },
    wiki: {
      title: 'Wiki-граф знаний',
      refresh: 'Обновить',
      notEnabled: 'Wiki не включена',
      notEnabledDesc: 'Wiki не включена для этого блокнота. Новые блокноты включают её по умолчанию.',
      notPublished: 'Заметка не опубликована',
      notPublishedDesc: 'Опубликуйте заметку, и ИИ автоматически извлечёт сущности, концепции и создаст Wiki-страницы.',
      summary: 'Сводка',
      related: 'Связанные страницы',
      backlinks: 'Обратные ссылки',
      noPages: 'Нет связанных Wiki-страниц — они появятся после публикации',
      typeSummary: 'Сводка',
      typeEntity: 'Сущность',
      typeConcept: 'Концепция',
      typeSynthesis: 'Синтез',
      typeComparison: 'Сравнение',
      typeIndex: 'Индекс',
      typeLog: 'Лог',
      suggestHint: 'Wiki / Заметки · Tab или Enter для выбора',
      typeNote: 'Заметка',
      insertLink: 'Вставить ссылку',
      viewPage: 'Просмотр',
      searchPlaceholder: 'Поиск Wiki-страниц…',
      tabAll: 'Все',
      tabLinks: 'Ссылки заметки',
      linkExists: 'Есть',
      linkMissing: 'Нет',
      noLinks: 'В этой заметке пока нет [[ссылок]]',
      noLinksHint: 'Введите [[ в редакторе, чтобы начать',
    },
    link: {
      suggestHint: 'Заметки · Tab / Enter для выбора',
    },
  },
  input: {
    addModel: 'Добавить модель',
