export default {
  ...
  model: {
    ...
    editor: {
      ...
      thinkingControlLabel: 'Формат параметра размышлений (расширенный)',
      thinkingControlDesc: 'Плагин модели на бэкенде выбирает его по документации поставщика. Переопределяйте только если автоопределение не совпадает с вашим развёртыванием.',
      ...
      thinkingControl: {
        auto: {
          label: 'Следовать плагину модели (рекомендуется)',
          hint: 'Бэкенд выбирает поле по документации поставщика'
        },
        autoField: 'Сейчас отправляется: {field}',
        autoNone: 'У этой модели нет переключателя размышлений',
        thinkingType: {
          label: 'thinking.type',
