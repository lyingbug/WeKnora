export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      dockerHostHelp: 'Empty uses the local unix:///var/run/docker.sock. For a remote daemon use tcp://host:2376 and turn on "allow private endpoints" below.',
      dockerTlsCertPath: 'TLS certificate directory',
      dockerTlsCertPathHelp: 'Directory on the WeKnora host holding ca.pem, cert.pem and key.pem. Only needed for a remote daemon; certificates are mounted by the deployment, never stored here.',
