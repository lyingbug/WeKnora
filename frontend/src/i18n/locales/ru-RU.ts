export default {
  ...
  memorySettings: {
    ...
    export: 'Экспорт',
    clear: 'Очистить всё',
    clearConfirm: 'Все ваши записи будут удалены безвозвратно. Продолжить?',
  ...
  memoryWorkspaceSettings: {
    ...
    introDescription: 'Долговременная память сохраняет сказанное участниками, поэтому она не включается сама. После включения у каждого участника своё изолированное пространство памяти, которое он может просматривать, изменять, удалять или полностью отключить в разделе «Моя память».',
