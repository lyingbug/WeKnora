export default {
  ...
  memory: {
    ...
    settings: {
      ...
      keys: {
        memory_enabled: { label: 'Enable long-term memory', help: 'When off, nothing is read and nothing is written. You can always switch it off for yourself.' },
        ...
        memory_write_mode: { label: 'How memories are recorded', help: 'From nothing at all, through only what you explicitly ask for, to automatic extraction.' },
        memory_write_require_review: { label: 'Ask me first', help: 'Extracted candidates wait in the review inbox until you accept them.' },
        memory_write_allowed_types: { label: 'Types that may be recorded', help: 'For example, preferences only.' },
        ...
        memory_recall_enabled: { label: 'Use memory in conversations', help: 'When off, memory is written but never read.' },
