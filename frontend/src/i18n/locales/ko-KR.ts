export default {
  ...
  settings: {
    ...
    notesMode: {
      title: "노트 모드 (Typora 스타일)",
      description:
        "켜면 사이드바에 노트·검색·대화·설정만 남고 홈은 노트 목록으로 열려 Markdown 작성에 집중할 수 있습니다.",
      switchedOn: "노트 모드를 켰습니다",
      switchedOff: "노트 모드를 껐습니다",
      navigateTitle: "노트 홈으로 이동",
      navigateBody: "지식베이스 또는 관리 페이지에 있습니다. 노트 목록으로 이동할까요?",
      navigateConfirm: "노트로 이동",
      exitMode: "노트 모드 종료",
    },
  ...
  manualEditor: {
    ...
    openInWindow: "새 창에서 편집",
  },
  notes: {
    defaultNotebookName: "내 노트",
    chat: {
      title: "노트 어시스턴트",
      headSub: "지식베이스에 질문 · 전체 화면 또는 새 대화",
      headOpenFull: "전체",
      headNewSession: "새 대화",
      closePanel: "닫기",
      openFull: "전체 대화로 열기",
      newSession: "새 대화",
      unavailable: "현재 사용할 수 없습니다. 다시 시도하세요.",
      retry: "다시 시도",
      createFailed: "대화를 시작하지 못했습니다",
    },
    welcome: {
      featWriteTitle: "방해 없는 글쓰기",
      featWriteDesc: "Typora 스타일의 전체 화면 Markdown, 자동 저장과 집중 모드.",
      featPublishTitle: "한 번의 클릭으로 게시",
      featPublishDesc: "초안은 색인 외, 게시하면 검색·답변에 활용됩니다.",
      featShortcutsTitle: "단축키",
      featShortcutsDesc: "저장·서식·미리보기를 손끝에서.",
      dragHint: ".md 파일을 편집기에 끌어다 놓아도 됩니다",
    },
    errors: {
      noModel: "노트용 지식베이스를 만들려면 먼저 모델 관리에서 기본 대화·임베딩 모델을 설정하세요.",
      createNotebookFailed: "기본 노트북 생성 실패",
    },
    list: {
      title: "노트",
      subtitle: "Markdown 초안, 게시 후 검색에 반영",
      newNote: "새 노트",
      ...
      kbScopeTitle: "노트북별",
      newNotebook: "새 노트북",
      notebookNamePlaceholder: "노트북 이름을 입력하세요",
      notebookBasicDesc: '노트북의 이름과 설명을 설정하세요.',
      notebookModelsDesc: '노트북에 적합한 AI 모델을 선택하세요.',
      notebookStorageGlobalDesc: '노트에서 추출된 비정형 및 정형 데이터를 저장하는 데 사용되는 스토리지 엔진을 구성하세요.',
      notebookStorageDesc: '이 노트북에 사용할 스토리지 엔진을 선택하세요. 전역 설정에서 해당 엔진이 구성되어 있어야 합니다.',
      notebookCreate: '노트북 생성',
      notebookNameLabel: "노트북 이름",
      notebookDescLabel: "노트북 설명",
      notebookDescPlaceholder: "노트북 설명을 입력하세요",
      filterAll: "전체",
      filterDraft: "초안",
      filterPublished: "게시됨",
      emptyTitle: "노트가 없습니다",
      emptyDesc: "노트를 만들거나 설정에서 노트 모드를 켜 집중 레이아웃을 사용하세요.",
      writeFirst: "첫 노트 쓰기",
      ...
      move: "다른 지식베이스로 이동",
      moveFailed: "이동 실패",
      moveTimeout: "이동이 아직 진행 중입니다. 목록이 맞지 않으면 잠시 후 새로고침하세요.",
      deleteConfirmTitle: "노트 삭제",
      deleteConfirmBody: "「{title}」을(를) 삭제할까요? 되돌릴 수 없습니다.",
      deleteFailed: "삭제 실패",
      unpublish: "초안으로 되돌리기",
      publish: "게시",
      tagDraft: "초안",
      ...
      untitled: "제목 없음",
      openInEditor: "편집기 열기",
      noNotesYet: "노트가 없습니다. 오른쪽에서 새로 만들어 보세요",
      noMatch: "조건에 맞는 노트가 없습니다",
    ...
    editor: {
      ...
      publishTitle: "색인에 게시",
      republish: "다시 게시",
      publishHint: "게시 후 내용이 벡터/키워드 색인에 포함되어 검색·답변에 사용됩니다.",
      chars: "{n}자",
      words: "{n}단어",
      saving: "저장 중…",
      savedJustNow: "저장됨",
      savedSecondsAgo: "{n}초 전 저장",
      savedMinutesAgo: "{n}분 전 저장",
      lastSaved: "{time}에 저장",
      kbNotReady: "모델 설정이 완료되지 않아 저장/게시를 할 수 없습니다. 설정에서 초기화를 완료하세요.",
      kbNoStorage: "이 지식베이스에 저장 엔진이 설정되지 않았습니다. 설정에서 선택하거나, 해당 지식베이스를 삭제하면 노트가 다시 만들어 줍니다.",
      kbDialogHint: "저장된 노트의 대상 지식베이스를 바꾸면 항목이 이동됩니다(기존 베이스에서 제거 후 새 베이스에 추가).",
      kbMoveConfirm: "「{name}」으로 이 노트를 이동할까요? 기존 지식베이스에서는 사라집니다.",
    },
    wiki: {
      title: 'Wiki 지식 그래프',
      refresh: '새로고침',
      notEnabled: 'Wiki 미활성화',
      notEnabledDesc: '이 노트북은 Wiki 기능이 활성화되지 않았습니다. 새 노트북은 기본으로 활성화됩니다.',
      notPublished: '노트 미게시',
      notPublishedDesc: '노트를 게시하면 AI가 자동으로 엔티티·개념을 추출하고 Wiki 페이지를 생성합니다.',
      summary: '요약',
      related: '관련 페이지',
      backlinks: '역링크',
      noPages: '아직 관련 Wiki 페이지가 없습니다. 게시 후 자동 생성됩니다.',
      typeSummary: '요약',
      typeEntity: '엔티티',
      typeConcept: '개념',
      typeSynthesis: '종합',
      ...
      typeIndex: '인덱스',
      typeLog: '로그',
      suggestHint: 'Wiki / 노트 · Tab 또는 Enter로 선택',
      typeNote: '노트',
      insertLink: '링크 삽입',
      viewPage: '보기',
      ...
      linkExists: '존재',
      linkMissing: '미생성',
      noLinks: '이 노트에 [[링크]]가 없습니다',
      noLinksHint: '편집기에서 [[를 입력하여 시작하세요',
    },
    link: {
      suggestHint: '노트 · Tab / Enter로 선택',
    },
  },
  createChat: {
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      typeNotebook: "노트북",
      typeDescription:
        "FAQ 유형은 구조화된 Q&A 데이터에 적합합니다. 문서 유형은 파일 파싱과 청킹을 지원합니다. Wiki 유형은 LLM을 통해 상호 연결된 지식 페이지를 자동으로 구축합니다. 노트북은 순수 텍스트와 마크다운 노트 전용입니다.",
      nameLabel: "지식베이스 이름",
