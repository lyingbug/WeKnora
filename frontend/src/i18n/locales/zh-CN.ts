export default {
  ...
  settings: {
    ...
    notesMode: {
      title: "笔记模式（Typora 风格）",
      description:
        "开启后侧边栏仅保留笔记、知识搜索、对话与设置，首页进入笔记列表，适合把 WeKnora 当作 Markdown 写作与知识录入工作台。",
      switchedOn: "已开启笔记模式",
      switchedOff: "已关闭笔记模式",
      navigateTitle: "进入笔记模式",
      navigateBody: "当前在知识库或管理相关页面。是否跳转到笔记首页？",
      navigateConfirm: "前往笔记",
      exitMode: "退出笔记模式",
    },
  ...
  notes: {
    defaultNotebookName: "我的笔记",
    chat: {
      title: "笔记助手",
      headSub: "向知识库提问；可全屏或新开会话",
      headOpenFull: "全屏",
      headNewSession: "新对话",
      closePanel: "收起侧栏",
      openFull: "在完整对话页打开",
      newSession: "新建对话",
      unavailable: "暂不可用，请稍后再试",
      retry: "重试",
      createFailed: "创建对话失败",
    },
    welcome: {
      featWriteTitle: "纯净写作",
      featWriteDesc: "Typora 风格的全屏 Markdown，自动保存、专注写作。",
      featPublishTitle: "一键发布",
      featPublishDesc: "草稿仅自己可见，发布后即可被 AI 检索与问答引用。",
      featShortcutsTitle: "顺手快捷键",
      featShortcutsDesc: "保存、加粗、预览触手可达。",
      dragHint: "也可以把 .md 文件拖入编辑器直接创建",
    },
    errors: {
      noModel: "请先在「模型管理」中配置默认对话模型与嵌入模型，再创建笔记知识库。",
      createNotebookFailed: "创建默认笔记本失败",
    },
    list: {
      title: "笔记",
      subtitle: "Markdown 写作与草稿，发布后可被知识库检索",
      newNote: "新建笔记",
      searchPlaceholder: "搜索标题或正文摘要",
      kbDefault: "我的笔记",
      kbAll: "全部笔记",
      kbScopeTitle: "按笔记本",
      newNotebook: "新建笔记本",
      notebookNamePlaceholder: "请输入笔记本名称",
      notebookBasicDesc: "设置笔记本的名称和描述信息。",
      notebookModelsDesc: "为笔记本选择合适的 AI 模型。",
      notebookStorageGlobalDesc: "配置用于存储笔记中提取出的一系列非结构化和结构化数据的存储引擎。",
      notebookStorageDesc: "选择该笔记本使用的存储引擎，需在全局设置中已配置对应引擎。",
      notebookCreate: "创建笔记本",
      notebookNameLabel: "笔记本名称",
      notebookDescLabel: "笔记本描述",
      notebookDescPlaceholder: "请输入笔记本描述",
      filterAll: "全部",
      filterDraft: "草稿",
      filterPublished: "已发布",
      emptyTitle: "还没有笔记",
      emptyDesc: "创建一条笔记，或使用设置中的「笔记模式」专注写作。",
      writeFirst: "写第一篇",
      loadFailed: "加载笔记失败",
      rename: "重命名",
      renameFailed: "重命名失败",
      ...
      move: "迁移到其他知识库",
      moveFailed: "迁移失败",
      moveTimeout: "迁移仍在后台进行，若列表未更新请稍候或刷新页面",
      deleteConfirmTitle: "删除笔记",
      deleteConfirmBody: "确定删除「{title}」吗？此操作不可恢复。",
      deleteFailed: "删除失败",
      unpublish: "取消发布",
      publish: "发布为知识",
      tagDraft: "草稿",
    ...
    editor: {
      ...
      publishTitle: "发布为知识",
      republish: "更新发布",
      publishHint: "发布后，笔记内容将作为知识，可被 AI 检索与问答引用。",
      chars: "字符 {n}",
      words: "字数 {n}",
      saving: "保存中…",
      savedJustNow: "已保存",
      savedSecondsAgo: "{n} 秒前已保存",
      savedMinutesAgo: "{n} 分钟前已保存",
      lastSaved: "最近保存 {time}",
      kbNotReady: "当前知识库未完成模型配置，无法保存或发布。请前往设置完成初始化。",
      kbNoStorage: "当前知识库未配置存储引擎，无法保存或发布。请到知识库设置选择存储后再试，或删除该知识库让笔记自动重建一个。",
      kbDialogHint: "修改已保存笔记的目标知识库时，将迁移条目（从原库移除并加入新库）。",
      kbMoveConfirm: "确定将本笔记迁移到「{name}」吗？原知识库中不再保留该条。",
    },
    wiki: {
      title: "Wiki 知识图谱",
      refresh: "刷新",
      notEnabled: "Wiki 未启用",
      notEnabledDesc: "该笔记本尚未启用 Wiki 功能。新建的笔记本会自动开启，旧笔记本可在知识库设置中手动开启。",
      notPublished: "笔记尚未发布",
      notPublishedDesc: "发布笔记后，AI 将自动提取实体、概念并生成 Wiki 页面。",
      summary: "本篇摘要",
      related: "关联页面",
      backlinks: "反向链接",
      noPages: "暂无关联 Wiki 页面，发布笔记后将自动生成",
      typeSummary: "摘要",
      typeEntity: "实体",
      typeConcept: "概念",
      typeSynthesis: "综合",
      ...
      linkMissing: "未创建",
      noLinks: "本文还没有 [[链接]]",
      noLinksHint: "在编辑器中输入 [[ 开始创建",
    },
    link: {
      suggestHint: "笔记 · Tab / Enter 选择",
    },
  },
  createChat: {
  ...
  knowledgeEditor: {
    ...
    basic: {
      ...
      typeWiki: "Wiki",
      typeNotebook: "笔记本",
      typeDescription: "FAQ 类型适合结构化问答数据；文档型支持文件解析与分块；Wiki 类型由 LLM 自动构建；笔记本专用于纯文本与 Markdown 笔记创作。",
      nameLabel: "知识库名称",
