export default {
  ...
  settings: {
    ...
    sandbox: {
      ...
      dockerHostHelp: '留空使用本机 unix:///var/run/docker.sock。远程守护进程填 tcp://host:2376，并在下方开启「允许访问私网地址」。',
      dockerTlsCertPath: 'TLS 证书目录',
      dockerTlsCertPathHelp: 'WeKnora 所在主机上包含 ca.pem、cert.pem、key.pem 的目录，仅远程守护进程需要。证书不入库，由部署方挂载。',
