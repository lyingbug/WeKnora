export default {
  ...
  memory: {
    title: '我的记忆',
    subtitle: '这里是 WeKnora 记住的关于你的事：你的身份、偏好、在做的项目、得出的结论和悬而未决的问题。每一条都可以查看、修改和删除。',
    subtitleShort: '查看、编辑和管理 WeKnora 记住的关于你的信息。',
    tabs: {
	  saved: '已保存',
	  history: '来自聊天',
      memories: '记忆',
      inbox: '待确认',
      graph: '图谱',
      memoriesCount: '记忆 ({count})',
      inboxCount: '待确认 ({count})',
    },
    stats: {
    ...
    list: {
      ...
      statusActive: '生效中',
      statusArchived: '已归档',
      empty: '还没有记忆。你可以手动新建，或者在对话中说「记住…」。',
	  historyEmpty: '还没有从聊天中归纳出可用信息。这里的内容只会在相关问题中被使用。',
      updated: '更新于 {date}',
      used: '被使用 {count} 次',
	  savedOrigin: '明确保存',
	  historyOrigin: '聊天归纳',
      strength: '强度 {value}%',
      strengthHint: '长期不被使用的记忆会逐渐减弱并自动归档；置顶可以免于衰减。',
      pin: '置顶',
      unpin: '取消置顶',
      pinned: '已置顶，不再衰减',
      unpinned: '已取消置顶',
      ...
      forget: '忘记',
      forgetHeader: '忘记这条记忆？',
      forgetBody: '「{title}」将被删除，同时移除它在知识库上的锚点。此操作不可撤销。',
      forgotten: '已忘记',
    },
    inbox: {
      intro: '这些是从你的话里提取出来的候选记忆，需要你确认后才会生效。可以直接改写再采纳。',
      empty: '没有待确认的候选记忆。',
    ...
    graph: {
      noAnchors: '这个空间还没有指向知识库的锚点。等你在对话里用到知识库，接触过的内容就会出现在这里。',
      modePersonal: '我的记忆',
      modeBridged: '记忆 ∩ 知识库',
      personalHint: '记忆之间通过 [[链接]] 相连。',
      bridgedHint: '虚线节点是你在知识库里接触过的内容；连线表示某条记忆明确锚定到了它。',
      bridgedHintShort: '虚线节点为知识库内容，实线表示记忆锚点。',
      legendMemory: '记忆',
      legendWiki: '知识库内容',
      empty: '还没有可以成图的记忆。',
      truncated: '已显示 {returned} / {total} 个节点。',
      helpTitle: '图谱操作',
      helpClick: '单击',
      helpClickDesc: '查看节点详情',
      helpDblClick: '双击记忆',
      helpDblClickDesc: '打开编辑抽屉',
      helpDrag: '拖拽',
      helpDragDesc: '移动节点位置',
      helpZoom: '滚轮',
      helpZoomDesc: '缩放画布',
      drawerEdit: '编辑记忆',
      drawerOpenWiki: '在知识库图谱中查看',
      drawerVersion: '版本 {ver}',
      drawerNoContent: '暂无正文',
      drawerSatelliteHint: '这是你在知识库里接触过的内容。记忆通过锚点与它关联，可在知识库图谱中查看详情。',
    },
    editor: {
      createHeader: '新建记忆',
      editHeader: '编辑记忆',
      ...
      saved: '已保存',
      reverted: '已回滚',
      conflict: '这条记忆刚刚被改动过，已为你重新载入最新内容。',
      emptyWarning: '请至少填写摘要或正文。',
      type: '类型',
      typeLocked: '类型是地址的一部分，创建后不可更改。',
      title: '标题',
      titlePlaceholder: '一句话概括这条记忆',
      summary: '摘要',
      summaryPlaceholder: '注入到对话中的那一行',
      summaryHint: '对话中实际用到的就是这一行，请写得简短明确。',
      content: '正文',
      contentPlaceholder: '详细内容，支持 Markdown',
      linkHint: '可以用 [[slug]] 链接到其他记忆，链接会出现在图谱里。',
      language: '语言',
      verbosity: '详略',
      format: '格式',
      codeStyle: '代码示例',
      pinned: '置顶',
      pinnedHint: '置顶的记忆不会随时间衰减。',
    ...
    forgetAll: {
      header: '忘记全部记忆？',
      body: '将删除你的全部记忆、原始观察记录和知识库锚点。此操作不可撤销。',
      confirm: '全部忘记',
      done: '已清空全部记忆',
    },
    illuminate: {
      ...
      mastered: '已掌握',
      flagged: '有异议',
      familiarHint: '你反复问过、最近还在接触的页面。',
      masteredHint: '你确认已理解，或本就是这个主题负责人的页面。',
      flaggedHint: '你纠正过或提出异议的页面。',
    ...
    settingsDrawer: {
      description: '控制记忆的写入、召回与隐私。更改会即时保存。',
    },
    settings: {
      showAdvanced: '显示全部设置',
      hideAdvanced: '收起其他设置',
      saved: '设置已保存',
      patternPlaceholder: '每行一条正则表达式',
      readonly: {
        on: '已开启',
        off: '已关闭',
        empty: '未设置',
      ...
      groups: {
        general: { title: '总开关', description: '记忆是否启用，以及在哪些渠道生效。' },
        write: { title: '写入与抽取', description: '什么会被记住，以及是否需要你先确认。' },
        recall: { title: '召回与注入', description: '对话时使用哪些记忆，以及占多少上下文预算。' },
        boost: { title: '个性化召回', description: '让你接触过的知识库内容在检索里排得更靠前。' },
        anchor: { title: '锚点与点亮', description: '记忆与知识库的关联，以及知识图谱的点亮效果。' },
        lifecycle: { title: '衰减与保留', description: '记忆如何随时间淡出，以及保留多久。' },
        privacy: { title: '隐私与安全', description: '敏感信息处理与注入防护。这些项只能收紧。' },
        insights: { title: '运营洞察', description: '跨成员的匿名聚合，用于发现知识库缺口。' },
      },
      options: {
        mentioned: '提到过',
        asked_about: '问到过',
      ...
      keys: {
        memory_enabled: { label: '启用长期记忆', help: '关闭后不再读取也不再写入任何记忆。你随时可以为自己关闭它。', label_tenant: '对全空间启用', help_tenant: '关闭后，所有成员都不再有长期记忆，个人设置里也无法打开。' },
        memory_channels: { label: '生效渠道', help: '哪些渠道的用户会拥有长期记忆空间。' },
        memory_embed_visitor_space: { label: '网页嵌入访客', help: '访客身份由客户端提供，默认不为其建立长期记忆。' },
        memory_shared_space_enabled: { label: '团队共享记忆', help: '为工作空间建立一个共享记忆空间。' },
        memory_write_mode: { label: '写入方式', help: '从完全不记，到只记你明确要求的，再到自动抽取。', label_tenant: '允许的最大写入方式', help_tenant: '成员最多能到这一档。选「只记我要求的」，成员就无法开启自动抽取。' },
        memory_write_require_review: { label: '写入前先问我', help: '自动抽取的候选先进待确认列表，由你决定是否采纳。', label_tenant: '强制先经成员确认', help_tenant: '开启后，自动抽取的候选一律先进待确认列表，成员不能跳过这一步。' },
        memory_write_allowed_types: { label: '允许记住的类型', help: '例如只记偏好，不记其他。', label_tenant: '允许的类型范围', help_tenant: '成员只能在这个范围内进一步缩小，不能超出。' },
        memory_write_min_confidence: { label: '最低置信度', help: '低于此置信度的候选直接丢弃。' },
        memory_write_gate_keywords: { label: '触发词', help: '出现这些说法时才考虑抽取，可按行业术语增补。' },
        memory_write_debounce_seconds: { label: '抽取去抖（秒）', help: '一个窗口内的多轮对话合并成一次抽取。' },
        memory_write_turn_interval: { label: '轮次间隔', help: '即使没有触发词，每 N 轮也考虑抽取一次。' },
        memory_write_max_notes_per_window: { label: '单次候选上限', help: '一次抽取最多产生多少条候选。' },
        memory_write_extraction_model_id: { label: '抽取模型', help: '留空则使用会话模型。' },
        memory_recall_enabled: { label: '在对话中使用记忆', help: '关闭后只写不读。', label_tenant: '允许在对话中使用记忆', help_tenant: '关闭后，所有成员的对话都不再注入记忆。' },
        memory_recall_relevance_enabled: { label: '按相关性召回', help: '关闭后只注入常驻记忆，连检索都不做。' },
        memory_recall_always_include_types: { label: '常驻注入类型', help: '这些类型的记忆每轮都会注入。' },
        memory_recall_max_items: { label: '单次条数上限', help: '一轮对话最多注入多少条记忆。' },
        memory_recall_injection_token_budget: { label: '注入 token 预算', help: '记忆占用的上下文上限，超出按优先级截断。' },
        memory_recall_timeout_ms: { label: '召回超时（毫秒）', help: '超时直接跳过，绝不拖慢回答。' },
        memory_boost_enabled: { label: '个性化召回加权', help: '默认关闭：开启前建议先在你的场景里评测。' },
        memory_boost_factor: { label: '加权系数', help: '锚定过的检索结果得分乘以该系数。' },
        memory_anchor_runtime_enabled: { label: '自动记录接触', help: '回答引用了哪些 Wiki 页就记一条锚点，零模型开销。' },
        memory_anchor_resolve_enabled: { label: '解析记忆锚点', help: '把记忆中提到的实体匹配到知识库页面。' },
        memory_overlay_enabled: { label: '允许点亮知识图谱', help: '在 Wiki 图谱上按个人接触程度着色。' },
        memory_overlay_familiar_threshold: { label: '「熟悉」阈值', help: '热度达到该值即视为熟悉。' },
        memory_overlay_mastered_threshold: { label: '「已掌握」阈值', help: '热度达到该值且有确认信号即视为已掌握。' },
        memory_overlay_relation_weights: { label: '关系权重', help: '不同互动方式对热度的贡献。' },
        memory_overlay_anchor_half_life_days: { label: '锚点半衰期（天）', help: '接触热度随时间减半的周期。' },
        memory_overlay_decay_exempt_relations: { label: '不衰减的关系', help: '负责人与收藏表达的是长期归属，不随时间变淡。' },
        memory_decay_enabled: { label: '启用衰减', help: '长期不用的记忆逐渐减弱并归档，而不是无限堆积。' },
        memory_decay_half_life_days: { label: '各类型半衰期（天）', help: '偏好可以很长，未解问题应该很短。' },
        memory_decay_archive_threshold: { label: '归档阈值', help: '强度低于该值即归档（仍可查看和恢复）。' },
        memory_capacity_max_pages_per_space: { label: '记忆条数上限', help: '超出后归档最弱的记忆。' },
        memory_retention_days: { label: '保留期（天）', help: '0 表示不自动清除，仅归档。' },
        memory_retention_purge_archived_after_days: { label: '归档后清除（天）', help: '0 表示永久保留归档记忆。' },
        memory_privacy_pii_redaction: { label: '个人信息处理', help: '对手机号、邮箱等直接标识符的处理方式。' },
        memory_privacy_blocked_patterns: { label: '禁止记录的模式', help: '命中即不落盘，内置凭证类模式始终生效。' },
        memory_privacy_admin_metadata_only: { label: '管理员仅可见元数据', help: '任何角色都没有读取他人记忆内容的接口。' },
        memory_security_injection_sanitize: { label: '注入前净化', help: '注入前剥离链接、代码围栏和指令式表述。' },
        memory_security_extract_sources: { label: '抽取来源', help: '只从你本人说的话里抽取，绝不从文档或工具结果里抽取。' },
        memory_privacy_export_enabled: { label: '允许导出', help: '允许成员导出自己的全部记忆。' },
        memory_privacy_forget_enabled: { label: '允许删除', help: '允许成员删除自己的记忆。' },
        memory_insights_enabled: { label: '启用洞察', help: '基于匿名聚合发现知识库缺口。' },
        memory_insights_k_anonymity: { label: 'k-匿名阈值', help: '少于这么多人接触过的条目不会展示。' },
      },
    },
    errors: {
      exportFailed: '导出失败',
