...
func AvailableToolDefinitions() []AvailableTool {
	return []AvailableTool{
		...
		{Name: ToolMemorySearch, Label: "搜索长期记忆", Description: "查找关于用户本人的长期记忆"},
		{Name: ToolMemoryReadPage, Label: "读取长期记忆", Description: "读取一条长期记忆的完整内容"},
		{Name: ToolMemoryRemember, Label: "记住", Description: "把用户明确要求记住的事实写入长期记忆"},
		{Name: ToolMemoryForget, Label: "忘记", Description: "删除一条长期记忆"},
