...
func RegisterSkillRoutes(r *gin.RouterGroup, skillHandler *handler.SkillHandler, g *rbacGuards) {
	skills := r.Group("/skills")
	{
		...
		skills.GET("/installed", g.Viewer(), skillHandler.ListInstalledSkills)
		...
		skills.POST("/preview-hub", g.Admin(), skillHandler.PreviewSkillHubPackage)
		skills.POST("/install-local", g.Admin(), skillHandler.InstallLocalSkillPackage)
		skills.POST("/install-hub", g.Admin(), skillHandler.InstallSkillHubPackage)
