...
async function scenario(options) {
  ...
  try {
    ...
    assert.match(dump.stdout, /name: dsh-weknora/, 'the composed tree must mount the plugin')
...
async function main() {
  ...
  try {
    ...
    assert.ok(manifest.dsh.profile.bundles.includes('dsh-weknora'), 'the bundle must join the profile layer list')
